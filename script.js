    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "הוצאת פרי עץ הדעת משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '2d4cc84d-1f37-4cbd-8b27-25d4ac3922d7',
                    name: data.name || '',
                    email: data.email || '',
